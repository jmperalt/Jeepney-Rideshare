...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	$passwordhash = MD5($password); // In the database, make datatype longer than 32 bits because hash value store more 
	...
	$sql = "SELECT * FROM jeepney_persons WHERE email = ? AND password = ? LIMIT 1";
	$q = $pdo->prepare($sql);
	...
	if($data) { // if successful login set session variables
		...
		echo "<script type='text/javascript'> document.location = 'fr_events.php'; </script>";
		exit();
	}
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="login.php" method="post">
				...
				<div class="form-actions">
					...
					&nbsp; &nbsp;
					<a class="btn btn-primary" href="fr_per_create2.php">Signup</a>
					<a class="btn btn-primary" href="#">Github Source Code</a>
				</div>
