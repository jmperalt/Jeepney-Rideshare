		...
		<div class="span10 offset1">
			...
			<div class="form-horizontal" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo trim($eventdata['fare_description']) . " (" . trim($eventdata['fare_location']) . ") ";?>
						</label>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="checkbox">
							<?php echo Functions::dayMonthDate($eventdata['fare_date']) . ", " . Functions::timeAmPm($eventdata['fare_time']);?>
						</label>
					</div>
				</div>
