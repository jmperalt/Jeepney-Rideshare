...
class Functions {
	...
	public function logoDisplay() {
		echo '<div> ';
		echo '<img src="img/jeepneyridesharelogo.PNG" width="50%" class="logo" alt="SVSU logo"/>';
		echo '</div>';
	}
	
	public function logoDisplay2() {
		echo '<div> ';
		echo '<img src="img/jeepneyridesharelogo.PNG" width="50%" class="logo2" alt="SVSU logo"/>';
		echo '</div>';
	}
} // end class: Functions
?>